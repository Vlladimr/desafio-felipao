...
let nickname = "Vlladimr"//variável de nome
...
//se a soma de hp+xp do heroi escolhido (x) for < do que requerido pra fase escolhida (y) o heroi nao sera elegível para a mesma
